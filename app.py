...
HIKER_API_TOKEN = os.getenv('HIKER_API_TOKEN')  # Hiker API access token
...
def handle_instagram_with_hiker(message):
    ...
    try:
        bot2.reply_to(message, "Fetching media from Instagram using Hiker API, please wait...")

        # Hiker API endpoint for downloading media
        hiker_api_url = "https://api.hikerapi.com/v2/media/download"  # Update if needed

        headers = {
            "x-access-key": HIKER_API_TOKEN,
